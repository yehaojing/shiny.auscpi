    ...
    dashboardBody(
        tabItems(
            tabItem(tabName = "overview",
                    ...
                    fluidRow(
                        box(title = "Hierarchy", status = "primary", solidHeader = TRUE, collapsible = TRUE,
                    ...
                    fluidRow(
                        box(
                            pickerInput("bar_data", "", list("% Quarter" = "measurePercQuarter",
                    ...
                    fluidRow(
                        box(
                            leafletOutput("map_plot") %>% addSpinner(spin = "cube")
                        ),
                        box(
